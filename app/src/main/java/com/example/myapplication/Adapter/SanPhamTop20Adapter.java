...
public class SanPhamTop20Adapter extends RecyclerView.Adapter<SanPhamTop20Adapter.ViewHolder> {
    Context context;
    ArrayList<SanPham> sanPhamArrayList;

    public SanPhamTop20Adapter(Context context, ArrayList<SanPham> sanPhamArrayList) {
