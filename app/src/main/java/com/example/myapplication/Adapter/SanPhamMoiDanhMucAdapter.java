...
public class SanPhamMoiDanhMucAdapter extends RecyclerView.Adapter<SanPhamMoiDanhMucAdapter.ViewHolder> {
    Context context;
    ArrayList<SanPham> sanPhamArrayList;

    public SanPhamMoiDanhMucAdapter(Context context, ArrayList<SanPham> sanPhamArrayList) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        View view = inflater.inflate(R.layout.item_sanpham_moi_danhmuc,viewGroup,false);
...
//        viewHolder.tvGiaSanPham.setText(sanPham.getPrice());
